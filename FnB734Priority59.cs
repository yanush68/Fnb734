...
#region Implementation
  ...
  public void Run()
  {
    ...
    foreach(var _ in ReadInfrastructure())
    {
      local.Checkpoint.CreatedTimestamp =
      ...
      local.DashboardStagingPriority35.Modifications =
        (local.DashboardStagingPriority35.Modifications ?? 0) + 1;
  ...
  private void CreateDashboardStagingPriority35()
  {
    ...
    var param = 0M;
    var modifications = local.DashboardStagingPriority35.Modifications ?? 0;
  ...
  {
    return ReadEachInSeparateTransaction("ReadInfrastructure",
      (db, command) =>
      {
        db.SetDateTime(
  ...
  private bool ReadServiceProviderOfficeServiceProvider()
  {
    ...
    return Read("ReadServiceProviderOfficeServiceProvider",
      (db, command) =>
      {
        ...
        db.SetDate(
          command, "effectiveDate", entities.Infrastructure.ReferenceDate);
      },
      (db, reader) =>
      {
  ...
  private void UpdateDashboardStagingPriority2()
  {
    var asOfDate = local.DashboardStagingPriority35.AsOfDate;
    var modifications =
      (entities.DashboardStagingPriority35.Modifications ?? 0) + 1;
