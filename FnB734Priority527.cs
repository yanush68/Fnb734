...
Test:
      ...
      ; ++local.ReportingPeriod.Index)
    {
      ...
      foreach(var _ in ReadLegalActionFipsTribunal())
      {
        ...
        local.DashboardStagingPriority35.Petitions =
          (local.DashboardStagingPriority35.Petitions ?? 0) + 1;
  ...
  private void CreateDashboardStagingPriority35()
  {
    ...
    var param = 0M;
    var petitions = local.DashboardStagingPriority35.Petitions ?? 0;
  ...
  {
    var asOfDate = local.DashboardStagingPriority35.AsOfDate;
    var petitions = (entities.DashboardStagingPriority35.Petitions ?? 0) + 1;
