            ...
            (entities.LegalReferral.ReferralReason4, "EST"))
          {
            ...
            if (!IsEmpty(local.DashboardAuditData.JudicialDistrict))
            {
              ...
              local.Local1.Update.G.DaysToOrderEstblshmntNumer =
                (local.Local1.Item.G.DaysToOrderEstblshmntNumer ?? 0) + (
                  local.DashboardAuditData.DaysReported ?? 0);
              local.Local1.Update.G.DaysToOrderEstblshmntDenom =
                (local.Local1.Item.G.DaysToOrderEstblshmntDenom ?? 0) + 1;

              if ((local.Local1.Item.G.DaysToOrderEstblshmntNumer ?? 0) > 0 && (
                local.Local1.Item.G.DaysToOrderEstblshmntDenom ?? 0) > 0)
              {
                local.Local1.Update.G.DaysToOrderEstblshmntAvg =
                  (decimal)(local.Local1.Item.G.DaysToOrderEstblshmntNumer ?? 0) /
                  (local.Local1.Item.G.DaysToOrderEstblshmntDenom ?? 0);
              }
              else
              {
                local.Local1.Update.G.DaysToOrderEstblshmntAvg = 0;
...
Next:
  ...
  private void CreateDashboardStagingPriority35()
  {
    ...
    var daysToOrderEstblshmntAvg =
      local.Local1.Item.G.DaysToOrderEstblshmntAvg ?? 0M;
  ...
  private IEnumerable<bool> ReadLegalActionLegalActionFipsTribunal()
  {
    return ReadEachInSeparateTransaction(
      ...
      (db, reader) =>
      {
        ...
        entities.N2dRead.Identifier = db.GetInt32(reader, 7);
        entities.N2dRead.Classification = db.GetString(reader, 8);
        entities.N2dRead.ActionTaken = db.GetString(reader, 9);
        entities.N2dRead.FiledDate = db.GetNullableDate(reader, 10);
        entities.N2dRead.StandardNumber = db.GetNullableString(reader, 11);
        entities.N2dRead.EstablishmentCode = db.GetNullableString(reader, 12);
        ...
        entities.N2dRead.Populated = db.GetNullableInt32(reader, 7) != null;
