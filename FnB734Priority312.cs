...
#region Implementation
  ...
  public void Run()
  {
      ...
      ; ++local.ReportingPeriod.Index)
    {
      ...
      foreach(var _ in ReadLegalActionTribunalFips())
      {
        ...
        if (!IsEmpty(local.DashboardAuditData.JudicialDistrict))
        {
          ...
          local.Local1.Update.G.ContemptOrderFilings =
            (local.Local1.Item.G.ContemptOrderFilings ?? 0) + 1;
        }
  ...
  private void CreateDashboardStagingPriority35()
  {
    ...
    var param = 0M;
    var contemptOrderFilings = local.Local1.Item.G.ContemptOrderFilings ?? 0;
  ...
  {
    return ReadEachInSeparateTransaction("ReadLegalActionTribunalFips",
      (db, command) =>
      {
      ...
      (db, reader) =>
      {
        ...
        entities.Tribunal.FipLocation = db.GetNullableInt32(reader, 8);
        entities.Tribunal.JudicialDistrict = db.GetString(reader, 9);
        ...
        entities.Tribunal.Populated = db.GetNullableString(reader, 7) != null;
