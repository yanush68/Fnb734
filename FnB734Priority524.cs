...
#region Implementation
  ...
  public void Run()
  {
    ...
    foreach(var _ in ReadInfrastructureCase())
    {
      ...
      local.DashboardStagingPriority35.CaseReviews =
        (local.DashboardStagingPriority35.CaseReviews ?? 0) + 1;
  ...
  private void CreateDashboardStagingPriority35()
  {
    ...
    var param = 0M;
    var caseReviews = local.DashboardStagingPriority35.CaseReviews ?? 0;
  ...
  private IEnumerable<bool> ReadInfrastructureCase()
  {
    return ReadEachInSeparateTransaction("ReadInfrastructureCase",
      ...
      (db, reader) =>
      {
        ...
        entities.Case1.Populated = db.GetNullableString(reader, 7) != null;
  ...
  private void UpdateDashboardStagingPriority2()
  {
    var asOfDate = local.DashboardStagingPriority35.AsOfDate;
    var caseReviews =
      (entities.DashboardStagingPriority35.CaseReviews ?? 0) + 1;
