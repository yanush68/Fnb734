...
#region Implementation
  ...
  public void Run()
  {
    ...
    // codes: EST, PAT.  Do not count referral if any other Referral Reason code
    // exists.
        ...
        (entities.LegalReferral.ReferralReason4, "EST"))
      {
        ...
        if (!IsEmpty(local.DashboardAuditData.JudicialDistrict))
        {
          ...
          local.Local1.Update.G.ReferralsToLegalForEst =
            (local.Local1.Item.G.ReferralsToLegalForEst ?? 0) + 1;
        }
      }
      else
      {
  ...
  private void CreateDashboardStagingPriority35()
  {
    ...
    var param = 0M;
    var referralsToLegalForEst = local.Local1.Item.G.ReferralsToLegalForEst ?? 0
      ;
