...
#region Implementation
      ...
      foreach(var _ in ReadLegalActionFipsTribunal())
      {
        ...
        if (!IsEmpty(local.DashboardAuditData.JudicialDistrict))
        {
          ...
          local.Local1.Update.G.ContemptMotionFilings =
            (local.Local1.Item.G.ContemptMotionFilings ?? 0) + 1;
        }
  ...
  private void CreateDashboardStagingPriority35()
  {
    ...
    var param = 0M;
    var contemptMotionFilings = local.Local1.Item.G.ContemptMotionFilings ?? 0;
  ...
  private IEnumerable<bool> ReadLegalActionFipsTribunal()
  {
    return ReadEachInSeparateTransaction("ReadLegalActionFipsTribunal",
      ...
      (db, reader) =>
      {
        ...
        entities.Tribunal.FipLocation = db.GetNullableInt32(reader, 9);
        ...
        entities.Tribunal.Populated = db.GetNullableString(reader, 10) != null;
