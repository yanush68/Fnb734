...
#region Implementation
  ...
  public void Run()
  {
    ...
    foreach(var _ in ReadIncomeSourceCsePersonCase())
    {
      ...
      foreach(var _1 in ReadInfrastructure())
      {
        ...
        local.DashboardStagingPriority35.NcpLocatesByEmployer =
          (local.DashboardStagingPriority35.NcpLocatesByEmployer ?? 0) + 1;
  ...
  private void CreateDashboardStagingPriority35()
  {
    ...
    var ncpLocatesByEmployer =
      local.DashboardStagingPriority35.NcpLocatesByEmployer ?? 0;
  ...
  {
    return ReadEachInSeparateTransaction("ReadIncomeSourceCsePersonCase",
      (db, command) =>
      {
  ...
  private bool ReadServiceProviderOfficeServiceProvider()
  {
    ...
    return Read("ReadServiceProviderOfficeServiceProvider",
      (db, command) =>
      {
        ...
        db.SetDate(command, "effectiveDate", entities.IncomeSource.ReturnDt);
      },
      (db, reader) =>
      {
  ...
  private void UpdateDashboardStagingPriority2()
  {
    var asOfDate = local.DashboardStagingPriority35.AsOfDate;
    var ncpLocatesByEmployer =
      (entities.DashboardStagingPriority35.NcpLocatesByEmployer ?? 0) + 1;
